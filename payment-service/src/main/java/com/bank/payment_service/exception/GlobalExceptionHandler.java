...
public class GlobalExceptionHandler {
    ...
    // Exception when the total payment doesn't match the expected amount
    @ExceptionHandler(PaymentTotalAmountException.class)
    public ResponseEntity<Map<String, String>> handlePaymentTotalAmountException(PaymentTotalAmountException ex) {
        Map<String, String> response = new HashMap<>();
        response.put("error","Invalid total amount");
        response.put("message",ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.UNPROCESSABLE_ENTITY);
    }

    // Exception when a payment method doesn't exist
    @ExceptionHandler(PaymentMethodNotFoundException.class)
    public ResponseEntity<Map<String, String>> handlePaymentMethodNotFoundException(PaymentMethodNotFoundException ex) {
        Map<String, String> response = new HashMap<>();
